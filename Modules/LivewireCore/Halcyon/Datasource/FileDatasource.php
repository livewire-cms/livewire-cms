<?php namespace Modules\LivewireCore\Halcyon\Datasource;

use Illuminate\Filesystem\Filesystem;
use Modules\LivewireCore\Filesystem\PathResolver;
use Modules\LivewireCore\Halcyon\Processors\Processor;
use Modules\LivewireCore\Halcyon\Exception\CreateFileException;
use Modules\LivewireCore\Halcyon\Exception\DeleteFileException;
use Modules\LivewireCore\Halcyon\Exception\FileExistsException;
use Modules\LivewireCore\Halcyon\Exception\InvalidFileNameException;
use Modules\LivewireCore\Halcyon\Exception\CreateDirectoryException;
...
class FileDatasource extends Datasource implements DatasourceInterface
{
     ...
     *
     * @var \Modules\LivewireCore\Filesystem\Filesystem
     */
    protected $files;
