...
use Arr;
use Str;
use Modules\LivewireCore\Argon\Argon;
...
class Model extends EloquentModel
{
    ...
    use \Modules\LivewireCore\Database\Traits\DeferredBinding;
    ...
    protected function bootNicerEvents()
    {
        ...
        static::registerModelEvent('booted', function ($model) {
             ...
             * > **Note:** also triggered in Modules\LivewireCore\Halcyon\Model
             *
             * Example usage:
             *
             *     $model->bindEvent('model.afterBoot', function () use (\Modules\LivewireCore\Database\Model $model) {
    ...
    protected function beforeCreate()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.beforeCreate', function () use (\Modules\LivewireCore\Database\Model $model) {
         *         if (!$model->isValid()) {
    ...
    protected function afterCreate()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.afterCreate', function () use (\Modules\LivewireCore\Database\Model $model) {
    ...
    protected function beforeUpdate()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.beforeUpdate', function () use (\Modules\LivewireCore\Database\Model $model) {
         *         if (!$model->isValid()) {
         *             throw new \Exception("Invalid Model!");
         *         }
         *     });
    ...
    protected function afterUpdate()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.afterUpdate', function () use (\Modules\LivewireCore\Database\Model $model) {
    ...
    protected function beforeSave()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.beforeSave', function () use (\Modules\LivewireCore\Database\Model $model) {
         *         if (!$model->isValid()) {
         *             throw new \Exception("Invalid Model!");
         *         }
         *     });
    ...
    protected function afterSave()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.afterSave', function () use (\Modules\LivewireCore\Database\Model $model) {
         *         if ($model->title !== $model->original['title']) {
         *             \Log::info("{$model->name} updated its title!");
         *         }
         *     });
    ...
    protected function beforeDelete()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.beforeDelete', function () use (\Modules\LivewireCore\Database\Model $model) {
    ...
    protected function afterDelete()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.afterDelete', function () use (\Modules\LivewireCore\Database\Model $model) {
    ...
    protected function beforeFetch()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.beforeFetch', function () use (\Modules\LivewireCore\Database\Model $model) {
    ...
    protected function afterFetch()
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.afterFetch', function () use (\Modules\LivewireCore\Database\Model $model) {
     ...
     *
     * @return \Modules\LivewireCore\Argon\Argon
     */
     ...
     * @return \Modules\LivewireCore\Database\Builder|static
     */
     ...
     *
     * @param  array  $models
     * @return \Modules\LivewireCore\Database\Collection
     */
     ...
     * @param  \Modules\LivewireCore\Database\Model  $parent
     * @param  array  $attributes
     * @param  string  $table
     * @param  bool  $exists
     * @param  string|null  $using
     * @return \Modules\LivewireCore\Database\Pivot
     */
    ...
    protected function saveInternal($options = [])
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.saveInternal', function ((array) $attributes, (array) $options) use (\Modules\LivewireCore\Database\Model $model) {
    ...
    public function getAttributeValue($key)
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.beforeGetAttribute', function ((string) $key) use (\Modules\LivewireCore\Database\Model $model) {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.getAttribute', function ((string) $key, $value) use (\Modules\LivewireCore\Database\Model $model) {
         *         if ($key === 'not-for-you-to-look-at') {
    ...
    public function setAttribute($key, $value)
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.beforeSetAttribute', function ((string) $key, $value) use (\Modules\LivewireCore\Database\Model $model) {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.setAttribute', function ((string) $key, $value) use (\Modules\LivewireCore\Database\Model $model) {
         *         if ($key === 'not-for-you-to-touch') {
