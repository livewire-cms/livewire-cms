<?php namespace Modules\LivewireCore\Database\Traits;

use DbDongle;
use Modules\LivewireCore\Database\Collection;
use Modules\LivewireCore\Database\TreeCollection;
use Modules\LivewireCore\Database\NestedTreeScope;
 ...
 *
 *   use \Modules\LivewireCore\Database\Traits\NestedTree;
 *
...
trait NestedTree
{
     ...
     * @return \Modules\LivewireCore\Database\Model
     */
     ...
     *
     * @param \Modules\LivewireCore\Database\Model $node
     * @return boolean
     */
    ...
    protected function moveTo($target, $position)
    {
         ...
         * Validate target
         */
        if ($target instanceof \Modules\LivewireCore\Database\Model) {
            $target->reload();
        }
        else {
     ...
     *
     * @param Modules\LivewireCore\Database\Model $node The node to be moved
     * @param Modules\LivewireCore\Database\Model $target The target node to be moved relative to
     * @param string $position One of the following values: child, left, right
     * @return int
     */
