...
trait SoftDelete
{
    ...
    public static function bootSoftDelete()
    {
        ...
        static::restoring(function ($model) {
             ...
             * Example usage:
             *
             *     $model->bindEvent('model.beforeRestore', function () use (\Modules\LivewireCore\Database\Model $model) {
        ...
        static::restored(function ($model) {
             ...
             * Example usage:
             *
             *     $model->bindEvent('model.afterRestore', function () use (\Modules\LivewireCore\Database\Model $model) {
