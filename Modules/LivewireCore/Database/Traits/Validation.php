...
use Modules\LivewireCore\Database\ModelException;
...
trait Validation
{
    ...
    /**
     * @var bool Makes the validation procedure throw an {@link Modules\LivewireCore\Database\ModelException}
    ...
    public function validate($rules = null, $customMessages = null, $attributeNames = null)
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.beforeValidate', function () use (\Modules\LivewireCore\Database\Model $model) {
        ...
        if (($this->fireModelEvent('validating') === false) || ($this->fireEvent('model.beforeValidate', [], true) === false)) {
            if ($throwOnValidation) {
                ...
                throw new ValidationException($this->erros()->messages());
        ...
        if (!empty($rules)) {
            ...
            // dd($translations,$attributeNames);
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.afterValidate', function () use (\Modules\LivewireCore\Database\Model $model) {
