...
class BelongsToMany extends BelongsToManyBase
{
    ...
    public function attach($id, array $attributes = [], $touch = true)
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.relation.beforeAttach', function (string $relationName, array $attachedIdList, array $insertData) use (\Modules\LivewireCore\Database\Model $model) {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.relation.afterAttach', function (string $relationName, array $attachedIdList, array $insertData) use (\Modules\LivewireCore\Database\Model $model) {
    ...
    public function detach($ids = null, $touch = true)
    {
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.relation.beforeDetach', function (string $relationName, array $attachedIdList) use (\Modules\LivewireCore\Database\Model $model) {
         *         if (!$model->isRelationValid($attachedIdList)) {
         *             throw new \Exception("Invalid relation!");
         *             return false;
         *         }
         ...
         * Example usage:
         *
         *     $model->bindEvent('model.relation.afterDetach', function (string $relationName, array $attachedIdList) use (\Modules\LivewireCore\Database\Model $model) {
     ...
     * @return \Modules\LivewireCore\Support\Collection
     */
