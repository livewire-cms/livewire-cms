<?php namespace Modules\LivewireCore\Database\Behaviors;

use Exception;
use Modules\LivewireCore\Database\SortableScope;
 ...
 *
 *   public $implement = ['\Modules\LivewireCore\Database\Traits\Sortable'];
 *
 * To set orders:
 *
