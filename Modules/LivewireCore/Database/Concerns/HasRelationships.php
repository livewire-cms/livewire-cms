<?php namespace Modules\LivewireCore\Database\Concerns;

use Modules\LivewireCore\Support\Str;
use Modules\LivewireCore\Database\Relations\BelongsTo;
use Modules\LivewireCore\Database\Relations\BelongsToMany;
use Modules\LivewireCore\Database\Relations\HasMany;
use Modules\LivewireCore\Database\Relations\HasOne;
use Modules\LivewireCore\Database\Relations\MorphMany;
use Modules\LivewireCore\Database\Relations\MorphToMany;
use Modules\LivewireCore\Database\Relations\MorphTo;
use Modules\LivewireCore\Database\Relations\MorphOne;
use Modules\LivewireCore\Database\Relations\AttachMany;
use Modules\LivewireCore\Database\Relations\AttachOne;
use Modules\LivewireCore\Database\Relations\HasManyThrough;
use Modules\LivewireCore\Database\Relations\HasOneThrough;
...
trait HasRelationships
{
    ...
    /**
     * protected $attachOne = [
     *     'picture' => ['Modules\LivewireCore\Database\Attach\File', 'public' => false]
     * ];
     */
    public $attachOne = [];
     ...
     *     'pictures' => ['Modules\LivewireCore\Database\Attach\File', 'name'=> 'imageable']
     * ];
     */
    public $attachMany = [];
     ...
     * @return \Modules\LivewireCore\Database\Relations\HasOne
     */
     ...
     * This code is a duplicate of Eloquent but uses a Storm relation class.
     * @return \Modules\LivewireCore\Database\Relations\MorphOne
     */
     ...
     * $relationsData} array.
     * @return \Modules\LivewireCore\Database\Relations\BelongsTo
     */
     ...
     * This code is a duplicate of Eloquent but uses a Storm relation class.
     * @return \Modules\LivewireCore\Database\Relations\HasMany
     */
     ...
     * This code is a duplicate of Eloquent but uses a Storm relation class.
     * @return \Modules\LivewireCore\Database\Relations\HasManyThrough
     */
     ...
     * This code is a duplicate of Eloquent but uses a Storm relation class.
     * @return \Modules\LivewireCore\Database\Relations\HasOneThrough
     */
     ...
     * This code is a duplicate of Eloquent but uses a Storm relation class.
     * @return \Modules\LivewireCore\Database\Relations\MorphMany
     */
     ...
     * @return \Modules\LivewireCore\Database\Relations\BelongsToMany
     */
     ...
     * This code is almost a duplicate of Eloquent but uses a Storm relation class.
     * @return \Modules\LivewireCore\Database\Relations\MorphToMany
     */
