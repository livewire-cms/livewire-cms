<?php namespace Modules\LivewireCore\Translation;
...
{
    use \Modules\LivewireCore\Support\Traits\KeyParser;
    ...
    public function get($key, array $replace = [], $locale = null, $fallback = true)
    {
         ...
         * dispatchs before the translator resolves the requested language key
         *
