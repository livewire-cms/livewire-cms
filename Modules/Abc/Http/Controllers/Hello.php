...
class Hello extends Controller
{
    ...
    public function __construct()
    {
        ...
        SideNavManager::setContext('Modules.Abc', 'hello');//选中侧边拦

    }
    public function index()
    {
        $this->asExtension('ListController')->index();
        return view('abc::hello.index',['widget'=>$this->widget]);

    }
    public function create()
    {
        $this->asExtension('FormController')->create();
        return view('abc::hello.create',['widget'=>$this->widget]);

    }
    public function update($id)
    {
        $this->asExtension('FormController')->update($id);
        return view('abc::hello.update', ['widget'=>$this->widget]);
