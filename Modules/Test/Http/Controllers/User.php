...
class User extends Controller
{
    ...
    public function __construct()
    {
        ...
        SideNavManager::setContext('Modules.Test', 'user');//选中侧边拦

    }
    public function index()
    {
        $this->asExtension('ListController')->index();
        return view('test::user.index',['widget'=>$this->widget]);

    }
    public function create()
    {
        $this->asExtension('FormController')->create();
        return view('test::user.create',['widget'=>$this->widget]);

    }
    public function update($id)
    {
        $this->asExtension('FormController')->update($id);
        return view('test::user.update', ['widget'=>$this->widget]);
