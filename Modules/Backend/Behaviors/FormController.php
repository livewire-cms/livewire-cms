...
class FormController extends ControllerBehavior
{
    ...
    public function initForm($model, $context = null)
    {
         ...
         */
        $this->formWidget = $this->makeWidget('Modules\Backend\Widgets\Form', $config);
        // dd($formFields,$config,$this->formWidget);
        // dd($this->formWidget);
         ...
         */
        if ($this->controller->isClassExtendedWith('Modules.Backend.Behaviors.RelationController')) {
    ...
    {
        return request('form_context', $this->context);
    }
    ...
    {
        $redirectUrl = null;
        if (request('close') && !\Str::endsWith($context, '-close')) {
            $context .= '-close';
        }
        ...
        if (\Str::startsWith($redirectUrl, 'http://') || \Str::startsWith($redirectUrl, 'https://')) {
    ...
    public function formGetRedirectUrl($context = null, $model = null)
    {
        ...
        $redirectSource = \Str::endsWith($context, '-close') ? 'redirectClose' : 'redirect';
