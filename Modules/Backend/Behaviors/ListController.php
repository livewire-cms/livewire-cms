...
class ListController extends ControllerBehavior
{
    ...
    public function makeList($definition = null)
    {
        ...
        // dd(231232,$definition,$listConfig);
         ...
         */
        $widget = $this->makeWidget(\Modules\Backend\Widgets\Lists::class, $columnConfig);
        ...
        if (isset($listConfig->toolbar)) {
            ...
            // dd(13213,$toolbarConfig);

            $toolbarWidget = $this->makeWidget(\Modules\Backend\Widgets\Toolbar::class, $toolbarConfig);
        ...
        if (isset($listConfig->filter)) {
            ...
            if (!empty($filterConfig->scopes)) {
                ...
                $filterWidget = $this->makeWidget(\Modules\Backend\Widgets\Filter::class, $filterConfig);
    ...
    public function index()
    {
        ...
        // ]);
        // dd($this['list']);
        // dd($this->listWidgets['list']->prepareVars());
        // return view('backend::behaviors.listcontroller.index',['list'=>$this]);
    }
    ...
    public function listGetConfig($definition = null)
    {
        ...
        if (!$config = Arr::get($this->listConfig, $definition)) {
