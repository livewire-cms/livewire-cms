...
use Modules\LivewireCore\Auth\Manager as StormAuthManager;
...
class AuthManager extends StormAuthManager
{
    ...
    protected $userModel = 'Modules\Backend\Models\User';

    protected $groupModel = 'Modules\Backend\Models\UserGroup';

    protected $throttleModel = 'Modules\Backend\Models\UserThrottle';
