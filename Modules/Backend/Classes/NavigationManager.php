...
{
    use \Modules\LivewireCore\Support\Traits\Singleton;
    use \Modules\System\Traits\LazyOwnerAlias;
    ...
    protected function loadItems()
    {
         ...
         *
         */
        Event::dispatch('backend.menu.extendItems', [$this]);
        // Event::dispatch('backend.sideNav.extendItems', [$this]);
