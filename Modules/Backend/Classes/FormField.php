...
class FormField
{
    ...
    {
        $result = \Arr::get($this->attributes, $position, []);
    ...
    protected function filterPresetAttributes($attributes, $position = 'field')
    {
        ...
        $presetField = \Arr::get($this->preset, 'field');
        $presetType = \Arr::get($this->preset, 'type');
        ...
        if ($prefixInput = \Arr::get($this->preset, 'prefixInput')) {
    ...
    {
        return \Arr::get($this->config, $value, $default);
    }
