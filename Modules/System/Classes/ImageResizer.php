...
use Modules\System\Models\File as SystemFileModel;
use Modules\LivewireCore\Database\Attach\File as FileModel;
use Modules\LivewireCore\Database\Attach\Resizer as DefaultResizer;
...
class ImageResizer
{
    ...
    public function getDefaultOptions()
    {
         ...
         *
         */
        Event::dispatch('system.resizer.getDefaultOptions', [&$defaultOptions]);
    ...
    public static function getAvailableSources()
    {
         ...
         *
         */
        Event::dispatch('system.resizer.getAvailableSources', [&$sources]);
    ...
    public function resize()
    {
        ...
        try {
             ...
             *
             */
            $processed = Event::dispatch('system.resizer.processResize', [$this, $tempPath], true);
            if (!$processed) {
             ...
             *
             */
            Event::dispatch('system.resizer.afterResize', [$this, $tempPath]);
