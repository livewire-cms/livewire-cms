...
class ControllerMakeCommand extends GeneratorCommand
{
    ...
    public function handle() : int
    {
        ...
        foreach (['config_list.yaml','config_form.yaml','config_relation.yaml','config_filter.yaml','_list_toolbar.htm','_form-header.htm','_form-footer.htm','_action.htm'] as $configFielName)
        {
